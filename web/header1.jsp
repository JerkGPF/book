...
<body>
	...
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a href="<%=basePath%>/index.jsp" target="_top"><img
				src="<%=basePath%>/img/logo.jpg" /></a>
			<c:if test="${!empty user}">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;欢迎您：<span
					style="color: red; font-weight: bold">${sessionScope.user.name}</span>&nbsp;&nbsp;&nbsp;&nbsp; 图书伴您畅游书海。
				...
				<div style="float: right; margin-right: 5px; margin-top: 10px">
					<a class="btn btn-default btn-sm" href="<%=basePath%>/showCart.jsp"
					   role="button">购物车</a>
				</div>
				<div style="float: right; margin-right: 5px; margin-top: 10px;padding-left: 10px">
					<a class="btn btn-default btn-sm"
					...
					<div class="modal fade" id="myModal1" tabindex="-1" role="dialog"
						...
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<form
									action="http://localhost:8080/book/client/ClientServlet?op=register"
									method="post">
									<div class="modal-body">
										<div class="form-group">
											<label for="exampleInputName2">Username:</label> <input
									...
									<div class="modal-footer">
										...
										<button type="submit" class="btn btn-primary"
											onclick="window.location='http://localhost:8080/book/client/ClientServlet?op=register'">注册</button>
									</div>
								</form>
							</div>
						</div>
