...
<body>
	...
	<script type="text/javascript">
		window.onload = function() {
			document.getElementById("bt1").onclick = function() {
				...
				//03.发送请求
				xhr.open("get",
						"/book/client/ClientServlet?op=addCart&book_id="
								+ book_id);
				//04.发送请求正文
				xhr.send(null);
				alert("添加成功!");
			...
			document.getElementById("a1").onclick = function() {
				...
				//03.发送请求
				xhr.open("get",
						"/book/client/ClientServlet?op=addfavorite&book_id="
								+ book_id);
				//04.发送请求正文
				xhr.send(null);
			}
	...
	<div
		style="background-color: rgb(244, 245, 244); margin-top: 50px; margin-left: 130px; width: 1200px; height: 50px">
	...
	<div
		style=" margin-left: 130px; width: 1150px; height: 600px">
		<div
			...
			<div style="margin-top: 60px; margin-left: 120px">
				...
				<button type="button" class="btn btn-danger"
					style="background-color: rgb(198, 46, 45); width: 160px; height: 43px; margin-left: 100px"
						onclick="window.location='<%=basePath%>/order/OrderServlet?op=buy&money=${book.book_price}&name=${book.book_name}'">
